...
# fixed_size = (500, 500)
# query_img = cv2.resize(query_img, fixed_size)
# similar_imgs = [cv2.resize(img, fixed_size) for img in similar_imgs]
#
...
#
# # Display the query image and the most similar images side by side
# concatenated_img = cv2.hconcat([query_img] + similar_imgs)
# cv2.imshow("query image and similar images", concatenated_img)
# cv2.waitKey(0)
